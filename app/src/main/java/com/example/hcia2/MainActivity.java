...
public class MainActivity extends AppCompatActivity {
    ...
    private static final int TILE_IMAGE_ID = R.drawable.umaru;

    private PuzzleGameState mGameState = PuzzleGameState.NONE;
    private int mPuzzleBoardSize = DEFAULT_BOARD_SIZE;
    ...
    private void initGames() {
        ...
        //createPuzzleTileViews with the appropriate width, height
    ...
    private void createPuzzleTileViews(int minTileViewWidth, int minTileViewHeight) {
        ...
        //  Set up TileViews (that will be what the user interacts with
    ...
    private void setLevel(){
        ...
        if(level < 3){
            Toast.makeText(MainActivity.this, "等级至少为3！", Toast.LENGTH_SHORT).show();
            return;
        }else{
